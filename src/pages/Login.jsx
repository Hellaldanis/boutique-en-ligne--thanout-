        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 border border-gray-100 dark:border-gray-700">
            ...
            <div className="flex gap-2 mb-8 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-900 dark:to-gray-800 p-1.5 rounded-2xl relative overflow-hidden">
              {/* Indicateur animé */}
              <motion.div
                className="absolute inset-y-1.5 left-1.5 w-[calc(50%-0.375rem)] bg-gradient-to-r from-primary to-blue-600 rounded-xl shadow-lg"
            ...
            >
              <h1 className="text-3xl font-bold mb-2 bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">Connexion</h1>
